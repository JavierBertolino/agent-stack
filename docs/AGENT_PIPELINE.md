...
It also writes project-local platform configuration and registers the Linear
MCP server using `LINEAR_MCP_NAME` and `LINEAR_MCP_URL`. Credentials and OAuth
state remain outside the repository files generated by this kit.
